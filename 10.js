...
function restasucesivas() {
    let a = parseInt(prompt("Ingrese un número para restar sucesivamente"));
    let b = parseInt(prompt("Ingrese el valor a restar en cada paso"));
    let resta=0;
    let contador = 0;
    while (a-b > 0) {
        a -= b;
    ...
    console.log(`El valor final es: ${a}`);
}restasucesivas();
